...
public class LoggerAdvice {
	...
	@Before("within(com.ym52n..*) && @annotation(loggerManage)")
	...
	@AfterReturning("within(com.ym52n..*) && @annotation(loggerManage)")
	public void addAfterReturningLogger(JoinPoint joinPoint, LoggerManage loggerManage) {
		logger.info("执行 " + loggerManage.description() + " 结束");
	}
	
	@AfterThrowing(pointcut = "within(com.ym52n..*) && @annotation(loggerManage)", throwing = "ex")
